...
#ratedecline
mean_var_0_1 = np.array(var.mean_ratedecline_arr_0_1)
mean_var_1_10 = np.array(var.mean_ratedecline_arr_1_10)
mean_var_10_25 = np.array(var.mean_ratedecline_arr_10_25)
mean_var_25_50 = np.array(var.mean_ratedecline_arr_25_50)
mean_var_50_100 = np.array(var.mean_ratedecline_arr_50_100)
mean_var_100_200 = np.array(var.mean_ratedecline_arr_100_200)
mean_var_200_500 = np.array(var.mean_ratedecline_arr_200_500)
mean_var_500_700 = np.array(var.mean_ratedecline_arr_500_700)

std_var_0_1 = np.array(var.std_ratedecline_arr_0_1)
std_var_1_10 = np.array(var.std_ratedecline_arr_1_10)
std_var_10_25 = np.array(var.std_ratedecline_arr_10_25)
std_var_25_50 = np.array(var.std_ratedecline_arr_25_50)
std_var_50_100 = np.array(var.std_ratedecline_arr_50_100)
std_var_100_200 = np.array(var.std_ratedecline_arr_100_200)
std_var_200_500 = np.array(var.std_ratedecline_arr_200_500)
std_var_500_700 = np.array(var.std_ratedecline_arr_500_700)

median_var_0_1 = np.array(var.median_ratedecline_arr_0_1)
median_var_1_10 = np.array(var.median_ratedecline_arr_1_10)
median_var_10_25 = np.array(var.median_ratedecline_arr_10_25)
median_var_25_50 = np.array(var.median_ratedecline_arr_25_50)
median_var_50_100 = np.array(var.median_ratedecline_arr_50_100)
median_var_100_200 = np.array(var.median_ratedecline_arr_100_200)
median_var_200_500 = np.array(var.median_ratedecline_arr_200_500)
median_var_500_700 = np.array(var.median_ratedecline_arr_500_700)
...
nrows = 8
ncols = 3
variable = 'Rate Decline'
units = '[°C/Day]'

fig, axs = plt.subplots(nrows=nrows,ncols=ncols,subplot_kw={'projection': proj_crs},figsize=(20,30))

uneven_levels = [0.005,0.01,0.05,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.24,0.26,0.28,0.3,0.4,0.5,0.75,1,1.72]
...
plt.tight_layout()
plt.savefig('mean_median_std_ratedecline_poly_sizerange_noaa_1.png',bbox_inches='tight')
