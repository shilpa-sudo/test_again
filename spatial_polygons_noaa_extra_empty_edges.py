...
mhwstate_p90 = np.zeros((132, 262,9861)) #create a zero array


# In[6]:


#arr[1:131,1:261,:].shape
...
for i in range(9861): 
    ...
    plt.savefig(f'/home/shilpa/glory_mat_analysis/noaa_polygons_spatial_extraempty_edges/{i}.png')
    plt.close(fig)
...
df.to_csv('/home/shilpa/glory_mat_analysis/noaa_polygons_spatial_extraempty_edges/polygonstats_full') 
...
df1.to_csv('/home/shilpa/glory_mat_analysis/noaa_polygons_spatial_extraempty_edges/polygoninfo_full') 
