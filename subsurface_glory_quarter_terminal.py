...
for j in range(141):
    for k in range(604):
        ...
        if events == 0:
            ...
            df.to_csv('/home/shilpa/glory_mat_analysis/glorys_quarter_depth2m/all_mhws_at_%s_%s.csv'%(lat,lon))


# In[ ]:


fnames = glob.glob('/home/shilpa/glory_mat_analysis/glorys_quarter_depth2m/all_mhws_at*') 
...
df_concat2.to_csv('/home/shilpa/glory_mat_analysis/glorys_quarter_depth2m/mhws_fullset_depth2m.csv')
