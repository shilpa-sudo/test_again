...
#ax.fill_between(datessfull[1860:2260],0,100,color='y',alpha = 0.3)
#ax.fill_between(datessfull[4560:4960],0,100,color='y',alpha = 0.3)
#ax.fill_between(datessfull[6060:6860],0,100,color='y',alpha = 0.3)
#ax.fill_between(datessfull[8260:9060],0,100,color='y',alpha = 0.3)
#ax.fill_between(datessfull[9460:9860],0,100,color='y',alpha = 0.3)
...
#cbar.set_label("No.of MHW events")
    ...
    plt.savefig('noaa_0.25degree_mhw_sensitive_areas_mhw_areas/periods_of_interest/mhw_state_%s.png'%i)
