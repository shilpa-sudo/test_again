...
mean_var = xr.open_dataset('polyareas_removed_noaa_93_22_mean_std_coping_window_days_pacific.nc')
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_1_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-1 square deg. removed)',units=' [Days]',i=1,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_10_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-10 square deg. removed)',units=' [Days]',i=2,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_25_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-25 square deg. removed)',units=' [Days]',i=3,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_50_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-50 square deg. removed)',units=' [Days]',i=4,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_100_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-100 square deg. removed)',units=' [Days]',i=5,j=0)
...
plt.tight_layout()
plt.savefig('mean_copingwindow_polygonareasremoved_noaa.png',bbox_inches='tight')
