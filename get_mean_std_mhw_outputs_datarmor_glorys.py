...
ds = xr.open_dataset('/home/datawork-lead/datarmor-only/shilpa/glorys_mhw_output_surface_test.nc')
...
mean_duration_arr = np.zeros((141,604))
std_duration_arr = np.zeros((141,604))

mean_intensity_max_arr = np.zeros((141,604))
std_intensity_max_arr = np.zeros((141,604))

mean_intensity_mean_arr = np.zeros((141,604))
std_intensity_mean_arr = np.zeros((141,604))

mean_intensity_cumulative_arr = np.zeros((141,604))
std_intensity_cumulative_arr = np.zeros((141,604))

mean_rateonset_arr= np.zeros((141,604)) 
std_rateonset_arr = np.zeros((141,604))

mean_ratedecline_arr = np.zeros((141,604))
std_ratedecline_arr= np.zeros((141,604)) 

mean_reaction_window_arr = np.zeros((141,604))
std_reaction_window_arr = np.zeros((141,604))

mean_coping_window_arr = np.zeros((141,604))
std_coping_window_arr = np.zeros((141,604))  

mean_recovery_window_arr = np.zeros((141,604))
std_recovery_window_arr = np.zeros((141,604))

mean_severity_arr = np.zeros((141,604))
std_severity_arr = np.zeros((141,604))

#mean_event_no_arr = np.zeros((141,604))  
#std_event_no_arr = np.zeros((141,604))  

max_event_no_arr = np.zeros((141,604)) 
...
xrds.to_netcdf('/home2/datawork/slal/glorys_output_mean_std.nc')
