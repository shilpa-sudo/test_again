...
max_intensity_all_countriesarr = np.array(max_temp_all_countries)
print(max_intensity_all_countriesarr.shape)
max_intensity_countriesarr_rs = max_intensity_all_countriesarr.reshape((9861,12))
...
morethan1 = np.array(morethan_1deg_intensity_all_countries).reshape((9861,12)) 
morethan2 = np.array(morethan_2deg_intensity_all_countries).reshape((9861,12))
morethan3 = np.array(morethan_3deg_intensity_all_countries).reshape((9861,12))
morethan4 = np.array(morethan_4deg_intensity_all_countries).reshape((9861,12))


# In[ ]:


dataframe1 = pd.DataFrame(morethan1) 
dataframe1.to_csv("daily_max_intensity_countries_noaaoisst_morethan1_spatialcover.csv")

dataframe2 = pd.DataFrame(morethan2) 
dataframe2.to_csv("daily_max_intensity_countries_noaaoisst_morethan2_spatialcover.csv")

dataframe3 = pd.DataFrame(morethan3) 
dataframe3.to_csv("daily_max_intensity_countries_noaaoisst_morethan3_spatialcover.csv")

dataframe4 = pd.DataFrame(morethan4) 
dataframe4.to_csv("daily_max_intensity_countries_noaaoisst_morethan4_spatialcover.csv")
