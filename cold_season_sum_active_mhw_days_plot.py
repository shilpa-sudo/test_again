...
var = xr.open_dataset('cold_season_polyareas_specific_sizes_range_noaa_93_22_sum_active_mhw_days.nc')

#sum active mhw days plot

sum_var_0_1 = np.array(var.cold_sum_mhw_days_pacific_0_1)
sum_var_1_10 = np.array(var.cold_sum_mhw_days_pacific_1_10)
sum_var_10_25 = np.array(var.cold_sum_mhw_days_pacific_10_25)
sum_var_25_50 = np.array(var.cold_sum_mhw_days_pacific_25_50)
sum_var_50_100 = np.array(var.cold_sum_mhw_days_pacific_50_100)
sum_var_100_200 = np.array(var.cold_sum_mhw_days_pacific_100_200)
sum_var_200_500 = np.array(var.cold_sum_mhw_days_pacific_200_500)
sum_var_500_700 = np.array(var.cold_sum_mhw_days_pacific_500_700)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=sum_var_0_1,
                  uneven_levels=uneven_levels,name='Cold season No. of MHW days 0-1 sqr degs',units=' [Days]',i=0,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=sum_var_1_10,
                  uneven_levels=uneven_levels,name='Cold season No. of MHW days 1-10 sqr degs',units=' [Days]',i=0,j=1)


easy_plot_unevencolorbars(lon=xx,lat=yy, data=sum_var_10_25,
                  uneven_levels=uneven_levels,name='Cold season No. of MHW days 10-25 sqr degs',units=' [Days]',i=1,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=sum_var_25_50,
                  uneven_levels=uneven_levels,name='Cold season No. of MHW days 25-50 sqr degs',units=' [Days]',i=1,j=1)


easy_plot_unevencolorbars(lon=xx,lat=yy, data=sum_var_50_100,
                  uneven_levels=uneven_levels,name='Cold season No. of MHW days 50-100 sqr degs',units=' [Days]',i=2,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=sum_var_100_200,
                  uneven_levels=uneven_levels,name='Cold season No. of MHW days 100-200 sqr degs',units=' [Days]',i=2,j=1)


easy_plot_unevencolorbars(lon=xx,lat=yy, data=sum_var_200_500,
                  uneven_levels=uneven_levels,name='Cold season No. of MHW days 200-500 sqr degs',units=' [Days]',i=3,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=sum_var_500_700,
                  uneven_levels=uneven_levels,name='Cold season No. of MHW days 500-700 square degrees',units=' [Days]',i=3,j=1)
...
plt.tight_layout()
plt.savefig('cold_sum_mhw_active_cells_noaa_polygon_size_range.png',bbox_inches='tight')
