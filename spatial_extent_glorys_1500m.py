...
temparr = np.array(ds.votemper[:,0,:,:]) #1450m
...
xrds.to_netcdf(f'145Om_glorys_quarter_spatial_extent_pdtime.nc')

print('the deed is done for depth 1450m')
