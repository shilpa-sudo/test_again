...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=std_var_all,
                  uneven_levels=uneven_levels,name='Std (All sizes)',units='Standard Deviation',i=0,j=1)

uneven_levels = np.arange(min_median, max_median, 1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_all,
                  uneven_levels=uneven_levels,name='Median',units=' [Days]',i=0,j=2)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_1_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Recovery window (0-1 square deg. removed)',units=' [Days]',i=1,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_1_rem,
                  uneven_levels=uneven_levels,name='Median ',units=' [Days]',i=1,j=2)


uneven_levels = np.arange(min_mean, max_mean, 1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_10_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Recovery window (0-10 square deg. removed)',units=' [Days]',i=2,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_10_rem,
                  uneven_levels=uneven_levels,name='Median ',units=' [Days]',i=2,j=2)


uneven_levels = np.arange(min_mean, max_mean, 1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_25_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Recovery window (0-25 square deg. removed)',units=' [Days]',i=3,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_25_rem,
                  uneven_levels=uneven_levels,name='Median ',units=' [Days]',i=3,j=2)


uneven_levels = np.arange(min_mean, max_mean, 1)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_50_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Recovery window (0-50 square deg. removed)',units=' [Days]',i=4,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_50_rem,
                  uneven_levels=uneven_levels,name='Median ',units=' [Days]',i=4,j=2)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_100_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Recovery window (0-100 square deg. removed)',units=' [Days]',i=5,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_100_rem,
                  uneven_levels=uneven_levels,name='Median ',units=' [Days]',i=5,j=2)
