...
uneven_levels = [min_mean,0.05,0.06,0.07,0.08,0.09,0.1,0.11,0.12,0.13,0.14,0.15,0.16,0.17,0.18,0.19,0.2,0.21,0.22,0.23,0.24, max_mean]
...
uneven_levels3 = [min_median,0.05,0.06,0.07,0.08,0.09,0.1,0.11,0.12,0.13,0.14,0.15,0.16,0.17,0.18,0.19,0.2,0.21,0.22,0.23,0.24, max_median]
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_1_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate decline (0-1 sqr deg. removed)',units=' [°C/Day]',i=1,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_10_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate decline (0-10 sqr deg. removed)',units=' [°C/Day]',i=2,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_25_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate decline (0-25 sqr deg. removed)',units=' [°C/Day]',i=3,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_50_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate decline (0-50 sqr deg. removed)',units=' [°C/Day]',i=4,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_50_rem,
                  uneven_levels=uneven_levels3,name='Median (0-50 sqr deg. removed) ',units=' [°C/Day]',i=4,j=2)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_100_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate decline (0-100 sqr deg. removed)',units=' [°C/Day]',i=5,j=0)
