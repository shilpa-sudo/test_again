...
ax = axs[0]
ax.plot(df_replacedgl.time,df_replacedgl['Solomon_Islands_%spatial_extent'], color='cyan',alpha = 0.7,linestyle='solid',label='% Solomon Islands GLORYS [1993-2019] ')
ax.plot(df_replacedn_1981_2023.time,df_replacedn_1981_2023['Solomon_Islands_%spatial_extent'], color='black',alpha = 0.5,linestyle='solid',label='% Solomon Islands NOAAOISST [1981-2023]')
ax.plot(noaa_macro_scale_1981_2023_replaced.time,noaa_macro_scale_1981_2023_replaced['Solomon_Islands_%spatial_extent'], color='magenta',alpha = 0.5,linestyle='solid',label='% Solomon Islands NOAAOISST Macroscale [1981-2023]')
ax.plot(glorys_macro_scale_1993_2019_replaced.time,glorys_macro_scale_1993_2019_replaced['Solomon_Islands_%spatial_extent'], color='green',alpha = 0.6,linestyle='solid',label='% Solomon Islands GLORYS Macroscale [1993-2019]')
ax.plot(coastal.time_dt,coastal['coastal_percentage'], color='blue',alpha = 0.4,linestyle='dashed',label='% Solomon Islands coastal GLORYS [1993-2023]')
ax.legend()
ax.set_ylim(0, 100)
...
ax.plot(noaa_macro_scale_1981_2023_replaced.time,noaa_macro_scale_1981_2023_replaced['Solomon_Islands_%spatial_extent'], color='magenta',alpha = 0.5,linestyle='solid',label='% Solomon Islands NOAAOISST Macroscale [1981-2023]')
#ax.plot(glorys_macro_scale_1993_2019_replaced.time,glorys_macro_scale_1993_2019_replaced['New_Caledonia_%spatial_extent'], color='green',alpha = 0.5,linestyle='solid',label='% New Caledonia GLORYS Macroscale [1993-2019]')
ax.plot(coastal.time_dt,coastal['coastal_percentage'], color='blue',alpha = 0.4,linestyle='dashed',label='% Solomon_Islands coastal GLORYS [1993-2023]')
ax.legend()
ax.set_ylim(0, 100)

fig.supylabel('% EEZ MHW spatial extent')
fig.savefig('/home/shilpa/glory_mat_analysis/coastal_points/timeseries_%eez_spatial_extent_solo.png')
