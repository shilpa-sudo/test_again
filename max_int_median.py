...
mean_var = xr.open_dataset('polyareas_removed_noaa_93_22_mean_std_median_intensity_max.nc')

#recovery_window_days_pacific
mean_var_all = np.array(mean_var.mean_intensity_max)
mean_var_0_1_rem = np.array(mean_var.mean_intensity_max_0_1_rem)
mean_var_0_10_rem = np.array(mean_var.mean_intensity_max_0_10_rem)
mean_var_0_25_rem = np.array(mean_var.mean_intensity_max_0_25_rem)
mean_var_0_50_rem = np.array(mean_var.mean_intensity_max_0_50_rem)
mean_var_0_100_rem = np.array(mean_var.mean_intensity_max_0_100_rem)

std_var_all = np.array(mean_var.std_intensity_max)
std_var_0_1_rem = np.array(mean_var.std_intensity_max_0_1_rem)
std_var_0_10_rem = np.array(mean_var.std_intensity_max_0_10_rem)
std_var_0_25_rem = np.array(mean_var.std_intensity_max_0_25_rem)
std_var_0_50_rem = np.array(mean_var.std_intensity_max_0_50_rem)
std_var_0_100_rem = np.array(mean_var.std_intensity_max_0_100_rem)

median_var_all = np.array(mean_var.median_intensity_max)
median_var_0_1_rem = np.array(mean_var.median_intensity_max_0_1_rem)
median_var_0_10_rem = np.array(mean_var.median_intensity_max_0_10_rem)
median_var_0_25_rem = np.array(mean_var.median_intensity_max_0_25_rem)
median_var_0_50_rem = np.array(mean_var.median_intensity_max_0_50_rem)
median_var_0_100_rem = np.array(mean_var.median_intensity_max_0_100_rem)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_all,
                  uneven_levels=uneven_levels,name='Mean MHW Intensity max (All sizes)',units=' [°C]',i=0,j=0)
...
uneven_levels3 = np.arange(min_median, max_median, 0.1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_all,
                  uneven_levels=uneven_levels3,name='Median (All sizes)',units=' [°C]',i=0,j=2)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_1_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Intensity max (0-1 sqr deg. removed)',units=' [°C]',i=1,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_1_rem,
                  uneven_levels=uneven_levels3,name='Median (0-1 sqr deg. removed) ',units=' [°C]',i=1,j=2)


#uneven_levels = np.arange(min_mean, max_mean, 1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_10_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Intensity max (0-10 sqr deg. removed)',units=' [°C]',i=2,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_10_rem,
                  uneven_levels=uneven_levels3,name='Median (0-10 sqr deg. removed) ',units=' [°C]',i=2,j=2)


#uneven_levels = np.arange(min_mean, max_mean, 1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_25_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Intensity max (0-25 sqr deg. removed)',units=' [°C]',i=3,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_25_rem,
                  uneven_levels=uneven_levels3,name='Median (0-25 sqr deg. removed) ',units=' [°C]',i=3,j=2)


#uneven_levels = np.arange(min_mean, max_mean, 1)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_50_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Intensity max (0-50 sqr deg. removed)',units=' [°C]',i=4,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_50_rem,
                  uneven_levels=uneven_levels3,name='Median (0-50 sqr deg. removed) ',units=' [°C]',i=4,j=2)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_100_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Intensity max (0-100 sqr deg. removed)',units=' [°C]',i=5,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_100_rem,
                  uneven_levels=uneven_levels3,name='Median (0-100 sqr deg. removed) ',units=' [°C]',i=5,j=2)
...
plt.tight_layout()
plt.savefig('mean_median_intensity_max_polygonareasremoved_noaa.png',bbox_inches='tight')
