...
mean_var = xr.open_dataset('polyareas_removed_noaa_93_22_mean_std_median_copingwindowdayspacific.nc')

#recovery_window_days_pacific
mean_var_all = np.array(mean_var.mean_coping_window_days_pacific)
mean_var_0_1_rem = np.array(mean_var.mean_coping_window_days_pacific_0_1_rem)
mean_var_0_10_rem = np.array(mean_var.mean_coping_window_days_pacific_0_10_rem)
mean_var_0_25_rem = np.array(mean_var.mean_coping_window_days_pacific_0_25_rem)
mean_var_0_50_rem = np.array(mean_var.mean_coping_window_days_pacific_0_50_rem)
mean_var_0_100_rem = np.array(mean_var.mean_coping_window_days_pacific_0_100_rem)

std_var_all = np.array(mean_var.std_coping_window_days_pacific)
std_var_0_1_rem = np.array(mean_var.std_coping_window_days_pacific_0_1_rem)
std_var_0_10_rem = np.array(mean_var.std_coping_window_days_pacific_0_10_rem)
std_var_0_25_rem = np.array(mean_var.std_coping_window_days_pacific_0_25_rem)
std_var_0_50_rem = np.array(mean_var.std_coping_window_days_pacific_0_50_rem)
std_var_0_100_rem = np.array(mean_var.std_coping_window_days_pacific_0_100_rem)

median_var_all = np.array(mean_var.median_coping_window_days_pacific)
median_var_0_1_rem = np.array(mean_var.median_coping_window_days_pacific_0_1_rem)
median_var_0_10_rem = np.array(mean_var.median_coping_window_days_pacific_0_10_rem)
median_var_0_25_rem = np.array(mean_var.median_coping_window_days_pacific_0_25_rem)
median_var_0_50_rem = np.array(mean_var.median_coping_window_days_pacific_0_50_rem)
median_var_0_100_rem = np.array(mean_var.median_coping_window_days_pacific_0_100_rem)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_all,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (All sizes)',units=' [Days]',i=0,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_1_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-1 sqr deg. removed)',units=' [Days]',i=1,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_10_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-10 sqr deg. removed)',units=' [Days]',i=2,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_25_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-25 sqr deg. removed)',units=' [Days]',i=3,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_50_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-50 sqr deg. removed)',units=' [Days]',i=4,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_100_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Coping window (0-100 sqr deg. removed)',units=' [Days]',i=5,j=0)
...
plt.tight_layout()
plt.savefig('mean_median_copingwindow_polygonareasremoved_noaa.png',bbox_inches='tight')
