...
ax = axs[0]
ax.plot(df_replacedgl.time,df_replacedgl['Vanuatu_spatial_%extent'], color='cyan',alpha = 0.7,linestyle='solid',label='% Vanuatu GLORYS [1993-2019] ')
ax.plot(df_replacedn_1981_2023.time,df_replacedn_1981_2023['Vanuatu_spatial_%extent'], color='black',alpha = 0.5,linestyle='solid',label='% Vanuatu NOAAOISST [1981-2023]')
ax.plot(noaa_macro_scale_1981_2023_replaced.time,noaa_macro_scale_1981_2023_replaced['Vanuatu_%spatial_extent'], color='magenta',alpha = 0.5,linestyle='solid',label='% Vanuatu NOAAOISST Macroscale [1981-2023]')
ax.plot(glorys_macro_scale_1993_2019_replaced.time,glorys_macro_scale_1993_2019_replaced['Vanuatu_%spatial_extent'], color='green',alpha = 0.6,linestyle='solid',label='% Vanuatu GLORYS Macroscale [1993-2019]')
ax.plot(coastal.time_dt,coastal['coastal_percentage'], color='blue',alpha = 0.4,linestyle='dashed',label='% Vanuatu coastal GLORYS [1993-2023]')
ax.legend()
ax.set_ylim(0, 100)
...
fig.savefig('/home/shilpa/glory_mat_analysis/coastal_points/timeseries_%eez_spatial_extent_vanuatu.png')
