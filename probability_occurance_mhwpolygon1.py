...
var = xr.open_dataset('probability_of_occurance_polyareas_specific_sizes_range_noaa_93_22.nc')

#prob of occurance at all times

var_0_1 = np.array(var.prob_occu_of_sp_size_poly_all_time_0_1)
var_1_10 = np.array(var.prob_occu_of_sp_size_poly_all_time_1_10)
var_10_25 = np.array(var.prob_occu_of_sp_size_poly_all_time_10_25)
var_25_50 = np.array(var.prob_occu_of_sp_size_poly_all_time_25_50)
var_50_100 = np.array(var.prob_occu_of_sp_size_poly_all_time_50_100)
var_100_200 = np.array(var.prob_occu_of_sp_size_poly_all_time_100_200)
var_200_500 = np.array(var.prob_occu_of_sp_size_poly_all_time_200_500)
var_500_700 = np.array(var.prob_occu_of_sp_size_poly_all_time_500_700)
...
uneven_levels = [0,0.002,0.004,0.006,0.008,0.01,0.012,0.014,0.016,0.018,0.02,0.022,0.024,0.026,0.028,0.03,0.05,0.1,0.25,0.5,1]
easy_plot_unevencolorbars(lon=xx,lat=yy, data=var_0_1,
                  uneven_levels=uneven_levels,name=f'{variablename} 0-1 {units_}',units=f'{units}',i=0,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=var_1_10,
                  uneven_levels=uneven_levels,name=f'{variablename} 1-10 {units_}',units=f'{units}',i=0,j=1)


easy_plot_unevencolorbars(lon=xx,lat=yy, data=var_10_25,
                  uneven_levels=uneven_levels,name=f'{variablename} 10-25 {units_}',units=f'{units}',i=1,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=var_25_50,
                  uneven_levels=uneven_levels,name=f'{variablename} 25-50 {units_}',units=f'{units}',i=1,j=1)


easy_plot_unevencolorbars(lon=xx,lat=yy, data=var_50_100,
                  uneven_levels=uneven_levels,name=f'{variablename} 50-100 {units_}',units=f'{units}',i=2,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=var_100_200,
                  uneven_levels=uneven_levels,name=f'{variablename} 100-200 {units_}',units=f'{units}',i=2,j=1)


easy_plot_unevencolorbars(lon=xx,lat=yy, data=var_200_500,
                  uneven_levels=uneven_levels,name=f'{variablename} 200-500 {units_}',units=f'{units}',i=3,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=var_500_700,
                  uneven_levels=uneven_levels,name=f'{variablename} 500-700 {units_}',units=f'{units}',i=3,j=1)
...
plt.tight_layout()
plt.savefig('prob_occurance_all_days_polygon_size_range.png',bbox_inches='tight')
