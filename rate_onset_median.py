...
mean_var = xr.open_dataset('polyareas_removed_noaa_93_22_mean_st_median_rateonset.nc')

#recovery_window_days_pacific
mean_var_all = np.array(mean_var.mean_rateonset)
mean_var_0_1_rem = np.array(mean_var.mean_rateonset_0_1_rem)
mean_var_0_10_rem = np.array(mean_var.mean_rateonset_0_10_rem)
mean_var_0_25_rem = np.array(mean_var.mean_rateonset_0_25_rem)
mean_var_0_50_rem = np.array(mean_var.mean_rateonset_0_50_rem)
mean_var_0_100_rem = np.array(mean_var.mean_rateonset_0_100_rem)

std_var_all = np.array(mean_var.std_rateonset)
std_var_0_1_rem = np.array(mean_var.std_rateonset_0_1_rem)
std_var_0_10_rem = np.array(mean_var.std_rateonset_0_10_rem)
std_var_0_25_rem = np.array(mean_var.std_rateonset_0_25_rem)
std_var_0_50_rem = np.array(mean_var.std_rateonset_0_50_rem)
std_var_0_100_rem = np.array(mean_var.std_rateonset_0_100_rem)

median_var_all = np.array(mean_var.median_rateonset)
median_var_0_1_rem = np.array(mean_var.median_rateonset_0_1_rem)
median_var_0_10_rem = np.array(mean_var.median_rateonset_0_10_rem)
median_var_0_25_rem = np.array(mean_var.median_rateonset_0_25_rem)
median_var_0_50_rem = np.array(mean_var.median_rateonset_0_50_rem)
median_var_0_100_rem = np.array(mean_var.median_rateonset_0_100_rem)
...
def easy_plot_unevencolorbars(lon,lat,data,i,j,name,units,uneven_levels):
    ...
    cbar = plt.colorbar(im, ax=axs[i,j],orientation="horizontal", shrink=1)
...
uneven_levels = [min_mean,0.0555,0.06,0.07,0.08,0.09,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.24,0.26,0.28,0.3,0.3551,0.4551, max_mean]
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_all,
                  uneven_levels=uneven_levels,name='Mean MHW Rate onset (All sizes)',units=' [°C/Day]',i=0,j=0)
...
uneven_levels3 = [min_median,0.0555,0.06,0.07,0.08,0.09,0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.24,0.26,0.28,0.3,0.3551,0.4551, max_median]
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_1_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate onset (0-1 sqr deg. removed)',units=' [°C/Day]',i=1,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_1_rem,
                  uneven_levels=uneven_levels3,name='Median (0-1 sqr deg. removed) ',units=' [°C/Day]',i=1,j=2)


#uneven_levels = np.arange(min_mean, max_mean, 1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_10_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate onset (0-10 sqr deg. removed)',units=' [°C/Day]',i=2,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_10_rem,
                  uneven_levels=uneven_levels3,name='Median (0-10 sqr deg. removed) ',units=' [°C/Day]',i=2,j=2)


#uneven_levels = np.arange(min_mean, max_mean, 1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_25_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate onset (0-25 sqr deg. removed)',units=' [°C/Day]',i=3,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_25_rem,
                  uneven_levels=uneven_levels3,name='Median (0-25 sqr deg. removed) ',units=' [°C/Day]',i=3,j=2)


#uneven_levels = np.arange(min_mean, max_mean, 1)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_50_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate onset (0-50 sqr deg. removed)',units=' [°C/Day]',i=4,j=0)

#uneven_levels = np.arange(min_std,max_std,0.1)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=std_var_0_50_rem,
                  uneven_levels=uneven_levels2,name='Std (0-50 square deg. removed)',units='Standard Deviation',i=4,j=1)

#uneven_levels = np.arange(min_median, max_median, 1)
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_50_rem,
                  uneven_levels=uneven_levels3,name='Median (0-50 square deg. removed) ',units=' [°C/Day]',i=4,j=2)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=mean_var_0_100_rem,
                  uneven_levels=uneven_levels,name='Mean MHW Rate onset (0-100 sqr deg. removed)',units=' [°C/Day]',i=5,j=0)
...
easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_var_0_100_rem,
                  uneven_levels=uneven_levels3,name='Median (0-100 sqr deg. removed) ',units=' [°C/Day]',i=5,j=2)
...
plt.tight_layout()
plt.savefig('mean_median_rateonset_polygonareasremoved_noaa.png',bbox_inches='tight')
