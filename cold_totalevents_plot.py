...
var = xr.open_dataset('cold_season_no_of_events_polyareas_specific_sizes_range_noaa_93_22.nc')

#No_mhw_events

var_0_1 = np.array(var.cold_season_no_mhw_events_pacific_0_1)
var_1_10 = np.array(var.cold_season_no_mhw_events_pacific_1_10)
var_10_25 = np.array(var.cold_season_no_mhw_events_pacific_10_25)
var_25_50 = np.array(var.cold_season_no_mhw_events_pacific_25_50)
var_50_100 = np.array(var.cold_season_no_mhw_events_pacific_50_100)
var_100_200 = np.array(var.cold_season_no_mhw_events_pacific_100_200)
var_200_500 = np.array(var.cold_season_no_mhw_events_pacific_200_500)
var_500_700 = np.array(var.cold_season_no_mhw_events_pacific_500_700)
...
varname = 'Cold season No. of MHW events'
units_ = '[events]'
...
plt.tight_layout()
plt.savefig('cold_total_num_events_noaa_polygon_size_range.png',bbox_inches='tight')
