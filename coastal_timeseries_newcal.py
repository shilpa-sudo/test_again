...
directory = '/media/shilpa/Expansion/coastal_test_newcal'
tokelau_files = [file for file in os.listdir(directory) if file.startswith("New Caledonia_spatial")]

# Read all CSV files and concatenate into a single DataFrame
dfs = []
for file in tokelau_files:
