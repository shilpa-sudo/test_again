...
for i in range(9861):
    ...
    percent_mhwstatelist_p50.append(pmhws_p50)
    
    percent_mhwstate_p75 = ((np.count_nonzero(mhwstate_p75[:,:,i]==1)/31810))*100   #31810 = number of cells with data
    pmhws_p75 = round(percent_mhwstate_p75,2)
    percent_mhwstatelist_p75.append(pmhws_p75)
    ...
    percent_mhwstatelist_p85.append(pmhws_p85)
    ...
    percent_mhwstatelist_p99.append(pmhws_p99)
...
pmhsarr_p75 = np.array(percent_mhwstatelist_p75)
dataframe_p75 = pd.DataFrame(pmhsarr_p75) 
dataframe_p75.to_csv("percent_mhw_state_noaa_quarterdegree_p75.csv")
...
ax.plot(datessfull,mhws_percentage_p99[:,1],'k', alpha = 0.5)
ax.plot(datessfull,mhws_percentage_p90[:,1],'b', alpha = 0.5)
ax.plot(datessfull,mhws_percentage_p85[:,1],'r', alpha = 0.5)
ax.plot(datessfull,mhws_percentage_p75[:,1],'m', alpha = 0.5)
ax.plot(datessfull,mhws_percentage_p50[:,1],'g', alpha = 0.5)
...
plt.savefig('noaaoistt_0.25degree_pdf_cdf/timeseries_sensitivities.png')
