...
# get files
cold_duration = xr.open_dataset('/home/shilpa/glory_mat_analysis/cold_season_polyareas_specific_sizes_range_noaa_93_22_mean_std_median_duration.nc')
cold_maxintensity = xr.open_dataset('/home/shilpa/glory_mat_analysis/cold_season_polyareas_specific_sizes_range_noaa_93_22_mean_std_median_intensitymax.nc')
hot_duration = xr.open_dataset('/home/shilpa/glory_mat_analysis/hot_season_polyareas_specific_sizes_range_noaa_93_22_mean_std_median_duration.nc')
hot_maxintensity = xr.open_dataset('/home/shilpa/glory_mat_analysis/hot_season_polyareas_specific_sizes_range_noaa_93_22_mean_std_median_intensity_max.nc')

hot_days = xr.open_dataset('hot_season_polyareas_specific_sizes_range_noaa_93_22_sum_active_mhw_days.nc')
cold_days = xr.open_dataset('cold_season_polyareas_specific_sizes_range_noaa_93_22_sum_active_mhw_days.nc')


hot_events = xr.open_dataset('hot_season_no_of_events_polyareas_specific_sizes_range_noaa_93_22.nc')
cold_events = xr.open_dataset('cold_season_no_of_events_polyareas_specific_sizes_range_noaa_93_22.nc')
...
mean_cold_dur_0_1 = np.array(cold_duration.mean_cold_season_duration_pacific_0_1)
mean_cold_dur_1_10 = np.array(cold_duration.mean_cold_season_duration_pacific_1_10)
mean_cold_dur_10_25 = np.array(cold_duration.mean_cold_season_duration_pacific_10_25)
mean_cold_dur_25_50 = np.array(cold_duration.mean_cold_season_duration_pacific_25_50)
mean_cold_dur_50_100 = np.array(cold_duration.mean_cold_season_duration_pacific_50_100)
mean_cold_dur_100_200 = np.array(cold_duration.mean_cold_season_duration_pacific_100_200)
mean_cold_dur_200_500 = np.array(cold_duration.mean_cold_season_duration_pacific_200_500)
mean_cold_dur_500_700 = np.array(cold_duration.mean_cold_season_duration_pacific_500_700)

median_cold_dur_0_1 = np.array(cold_duration.median_cold_season_duration_pacific_0_1)
median_cold_dur_1_10 = np.array(cold_duration.median_cold_season_duration_pacific_1_10)
median_cold_dur_10_25 = np.array(cold_duration.median_cold_season_duration_pacific_10_25)
median_cold_dur_25_50 = np.array(cold_duration.median_cold_season_duration_pacific_25_50)
median_cold_dur_50_100 = np.array(cold_duration.median_cold_season_duration_pacific_50_100)
median_cold_dur_100_200 = np.array(cold_duration.median_cold_season_duration_pacific_100_200)
median_cold_dur_200_500 = np.array(cold_duration.median_cold_season_duration_pacific_200_500)
median_cold_dur_500_700 = np.array(cold_duration.median_cold_season_duration_pacific_500_700)

mean_hot_dur_0_1 = np.array(hot_duration.mean_hot_season_duration_pacific_0_1)
mean_hot_dur_1_10 = np.array(hot_duration.mean_hot_season_duration_pacific_1_10)
mean_hot_dur_10_25 = np.array(hot_duration.mean_hot_season_duration_pacific_10_25)
mean_hot_dur_25_50 = np.array(hot_duration.mean_hot_season_duration_pacific_25_50)
mean_hot_dur_50_100 = np.array(hot_duration.mean_hot_season_duration_pacific_50_100)
mean_hot_dur_100_200 = np.array(hot_duration.mean_hot_season_duration_pacific_100_200)
mean_hot_dur_200_500 = np.array(hot_duration.mean_hot_season_duration_pacific_200_500)
mean_hot_dur_500_700 = np.array(hot_duration.mean_hot_season_duration_pacific_500_700)

median_hot_dur_0_1 = np.array(hot_duration.median_hot_season_duration_pacific_0_1)
median_hot_dur_1_10 = np.array(hot_duration.median_hot_season_duration_pacific_1_10)
median_hot_dur_10_25 = np.array(hot_duration.median_hot_season_duration_pacific_10_25)
median_hot_dur_25_50 = np.array(hot_duration.median_hot_season_duration_pacific_25_50)
median_hot_dur_50_100 = np.array(hot_duration.median_hot_season_duration_pacific_50_100)
median_hot_dur_100_200 = np.array(hot_duration.median_hot_season_duration_pacific_100_200)
median_hot_dur_200_500 = np.array(hot_duration.median_hot_season_duration_pacific_200_500)
median_hot_dur_500_700 = np.array(hot_duration.median_hot_season_duration_pacific_500_700)


mean_cold_max_int_0_1 = np.array(cold_maxintensity.mean_cold_season_intensity_max_pacific_0_1)
mean_cold_max_int_1_10 = np.array(cold_maxintensity.mean_cold_season_intensity_max_pacific_1_10)
mean_cold_max_int_10_25 = np.array(cold_maxintensity.mean_cold_season_intensity_max_pacific_10_25)
mean_cold_max_int_25_50 = np.array(cold_maxintensity.mean_cold_season_intensity_max_pacific_25_50)
mean_cold_max_int_50_100 = np.array(cold_maxintensity.mean_cold_season_intensity_max_pacific_50_100)
mean_cold_max_int_100_200 = np.array(cold_maxintensity.mean_cold_season_intensity_max_pacific_100_200)
mean_cold_max_int_200_500 = np.array(cold_maxintensity.mean_cold_season_intensity_max_pacific_200_500)
mean_cold_max_int_500_700 = np.array(cold_maxintensity.mean_cold_season_intensity_max_pacific_500_700)

median_cold_max_int_0_1 = np.array(cold_maxintensity.median_cold_season_intensity_max_pacific_0_1)
median_cold_max_int_1_10 = np.array(cold_maxintensity.median_cold_season_intensity_max_pacific_1_10)
median_cold_max_int_10_25 = np.array(cold_maxintensity.median_cold_season_intensity_max_pacific_10_25)
median_cold_max_int_25_50 = np.array(cold_maxintensity.median_cold_season_intensity_max_pacific_25_50)
median_cold_max_int_50_100 = np.array(cold_maxintensity.median_cold_season_intensity_max_pacific_50_100)
median_cold_max_int_100_200 = np.array(cold_maxintensity.median_cold_season_intensity_max_pacific_100_200)
median_cold_max_int_200_500 = np.array(cold_maxintensity.median_cold_season_intensity_max_pacific_200_500)
median_cold_max_int_500_700 = np.array(cold_maxintensity.median_cold_season_intensity_max_pacific_500_700)

mean_hot_max_int_0_1 = np.array(hot_maxintensity.mean_hot_season_intensity_max_pacific_0_1)
mean_hot_max_int_1_10 = np.array(hot_maxintensity.mean_hot_season_intensity_max_pacific_1_10)
mean_hot_max_int_10_25 = np.array(hot_maxintensity.mean_hot_season_intensity_max_pacific_10_25)
mean_hot_max_int_25_50 = np.array(hot_maxintensity.mean_hot_season_intensity_max_pacific_25_50)
mean_hot_max_int_50_100 = np.array(hot_maxintensity.mean_hot_season_intensity_max_pacific_50_100)
mean_hot_max_int_100_200 = np.array(hot_maxintensity.mean_hot_season_intensity_max_pacific_100_200)
mean_hot_max_int_200_500 = np.array(hot_maxintensity.mean_hot_season_intensity_max_pacific_200_500)
mean_hot_max_int_500_700 = np.array(hot_maxintensity.mean_hot_season_intensity_max_pacific_500_700)

median_hot_max_int_0_1 = np.array(hot_maxintensity.median_hot_season_intensity_max_pacific_0_1)
median_hot_max_int_1_10 = np.array(hot_maxintensity.median_hot_season_intensity_max_pacific_1_10)
median_hot_max_int_10_25 = np.array(hot_maxintensity.median_hot_season_intensity_max_pacific_10_25)
median_hot_max_int_25_50 = np.array(hot_maxintensity.median_hot_season_intensity_max_pacific_25_50)
median_hot_max_int_50_100 = np.array(hot_maxintensity.median_hot_season_intensity_max_pacific_50_100)
median_hot_max_int_100_200 = np.array(hot_maxintensity.median_hot_season_intensity_max_pacific_100_200)
median_hot_max_int_200_500 = np.array(hot_maxintensity.median_hot_season_intensity_max_pacific_200_500)
median_hot_max_int_500_700 = np.array(hot_maxintensity.median_hot_season_intensity_max_pacific_500_700)

hot_days_0_1 = np.array(hot_days.hot_sum_mhw_days_pacific_0_1)
hot_days_1_10 = np.array(hot_days.hot_sum_mhw_days_pacific_1_10)
hot_days_10_25 = np.array(hot_days.hot_sum_mhw_days_pacific_10_25)
hot_days_25_50 = np.array(hot_days.hot_sum_mhw_days_pacific_25_50)
hot_days_50_100 = np.array(hot_days.hot_sum_mhw_days_pacific_50_100)
hot_days_100_200 = np.array(hot_days.hot_sum_mhw_days_pacific_100_200)
hot_days_200_500 = np.array(hot_days.hot_sum_mhw_days_pacific_200_500)
hot_days_500_700 = np.array(hot_days.hot_sum_mhw_days_pacific_500_700)

cold_days_0_1 = np.array(cold_days.cold_sum_mhw_days_pacific_0_1)
cold_days_1_10 = np.array(cold_days.cold_sum_mhw_days_pacific_1_10)
cold_days_10_25 = np.array(cold_days.cold_sum_mhw_days_pacific_10_25)
cold_days_25_50 = np.array(cold_days.cold_sum_mhw_days_pacific_25_50)
cold_days_50_100 = np.array(cold_days.cold_sum_mhw_days_pacific_50_100)
cold_days_100_200 = np.array(cold_days.cold_sum_mhw_days_pacific_100_200)
cold_days_200_500 = np.array(cold_days.cold_sum_mhw_days_pacific_200_500)
cold_days_500_700 = np.array(cold_days.cold_sum_mhw_days_pacific_500_700)


hot_events_0_1 = np.array(hot_events.hot_season_no_mhw_events_pacific_0_1)
hot_events_1_10 = np.array(hot_events.hot_season_no_mhw_events_pacific_1_10)
hot_events_10_25 = np.array(hot_events.hot_season_no_mhw_events_pacific_10_25)
hot_events_25_50 = np.array(hot_events.hot_season_no_mhw_events_pacific_25_50)
hot_events_50_100 = np.array(hot_events.hot_season_no_mhw_events_pacific_50_100)
hot_events_100_200 = np.array(hot_events.hot_season_no_mhw_events_pacific_100_200)
hot_events_200_500 = np.array(hot_events.hot_season_no_mhw_events_pacific_200_500)
hot_events_500_700 = np.array(hot_events.hot_season_no_mhw_events_pacific_500_700)

cold_events_0_1 = np.array(cold_events.cold_season_no_mhw_events_pacific_0_1)
cold_events_1_10 = np.array(cold_events.cold_season_no_mhw_events_pacific_1_10)
cold_events_10_25 = np.array(cold_events.cold_season_no_mhw_events_pacific_10_25)
cold_events_25_50 = np.array(cold_events.cold_season_no_mhw_events_pacific_25_50)
cold_events_50_100 = np.array(cold_events.cold_season_no_mhw_events_pacific_50_100)
cold_events_100_200 = np.array(cold_events.cold_season_no_mhw_events_pacific_100_200)
cold_events_200_500 = np.array(cold_events.cold_season_no_mhw_events_pacific_200_500)
cold_events_500_700 = np.array(cold_events.cold_season_no_mhw_events_pacific_500_700)
...
easy_plot_unevencolorbars2(lon=xx,lat=yy, data=median_hot_dur_10_25-mean_cold_dur_10_25,
                  uneven_levels=uneven_levels2,name=f'Difference {size}',units= f'{cbarunits}',i=2,j=2)

size = '25-50 sqr.degs.'

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_hot_dur_25_50,
                  uneven_levels=uneven_levels1,name=f' Hot Season {variablename} {size}',units= f'{cbarunits}',i=3,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_cold_dur_25_50,
                  uneven_levels=uneven_levels1,name=f' Cold Season {variablename} {size}',units= f'{cbarunits}',i=3,j=1)

easy_plot_unevencolorbars2(lon=xx,lat=yy, data=median_hot_dur_25_50-mean_cold_dur_25_50,
                  uneven_levels=uneven_levels2,name=f'Difference {size}', units = f'{cbarunits}',i=3,j=2)

size = '50-100 sqr.degs.'

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_hot_dur_50_100,
                  uneven_levels=uneven_levels1,name=f' Hot Season {variablename} {size}',units= f'{cbarunits}',i=4,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_cold_dur_50_100,
                  uneven_levels=uneven_levels1,name=f' Cold Season {variablename} {size}',units= f'{cbarunits}',i=4,j=1)

easy_plot_unevencolorbars2(lon=xx,lat=yy, data=median_hot_dur_50_100-mean_cold_dur_50_100,
                  uneven_levels=uneven_levels2,name=f'Difference {size}',units = f'{cbarunits}',i=4,j=2)

size = '100-200 sqr.degs.'

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_hot_dur_100_200,
                  uneven_levels=uneven_levels1,name=f' Hot Season {variablename} {size}',units= f'{cbarunits}',i=5,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_cold_dur_100_200,
                  uneven_levels=uneven_levels1,name=f' Cold Season {variablename} {size}',units= f'{cbarunits}',i=5,j=1)

easy_plot_unevencolorbars2(lon=xx,lat=yy, data=median_hot_dur_100_200-mean_cold_dur_100_200,
                  uneven_levels=uneven_levels2,name=f'Difference {size}',units= f'{cbarunits}',i=5,j=2)

size = '200-500 sqr.degs.'

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_hot_dur_200_500,
                  uneven_levels=uneven_levels1,name=f' Hot Season {variablename} {size}',units= f'{cbarunits}',i=6,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_cold_dur_200_500,
                  uneven_levels=uneven_levels1,name=f' Cold Season {variablename} {size}',units= f'{cbarunits}',i=6,j=1)

easy_plot_unevencolorbars2(lon=xx,lat=yy, data=median_hot_dur_200_500-mean_cold_dur_200_500,
                  uneven_levels=uneven_levels2,name=f'Difference {size}',units=f'{cbarunits}',i=6,j=2)

size = '500-700 sqr.degs.'


easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_hot_dur_500_700,
                  uneven_levels=uneven_levels1,name= f' Hot Season {variablename} {size}',units= f'{cbarunits}',i=7,j=0)

easy_plot_unevencolorbars(lon=xx,lat=yy, data=median_cold_dur_500_700,
                  uneven_levels=uneven_levels1,name= f'Cold Season {variablename} {size}',units= f'{cbarunits}',i=7,j=1)

easy_plot_unevencolorbars2(lon=xx,lat=yy, data=median_hot_dur_500_700-mean_cold_dur_500_700,
                  uneven_levels=uneven_levels2,name=f'Difference {size}',units= f'{cbarunits}',i=7,j=2)


plt.tight_layout()
plt.savefig(f'/home/shilpa/glory_mat_analysis/compare_median_duration_hot_cold_seasons1.png')
